...
public:
    ...
    {
        prevY = 0;
        red = 0.141, green = 0.109, blue = 0.337;
...
//warna layar
    void display()
    {
    glClearColor(0.141f, 0.109f, 0.337f, 1.0f); //warna background
...
int main(void) {
    ...
    window = glfwCreateWindow(667, 480, "Projek Nama Amira Nabila", NULL, NULL);
    if (!window){
        glfwTerminate();
    }
